...
${errorInfo.componentStack}`);
  ...
  // extensions/lite-packaging/src/LitePackaging.tsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var litePackaging = reactExtension(
    "purchase.checkout.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LitePackaging, {})
  );
  var charityDonation = reactExtension(
    "purchase.checkout.reductions.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CharityDonation, {})
  );
  function LitePackaging() {
    ...
    const { litePackagingAvailable, defaultLitePackaging } = cartLines.reduce(
      (acc, item) => {
        ...
        return {
          litePackagingAvailable: acc.litePackagingAvailable || checkoutInfo.includes("litePackagingAvailable"),
          defaultLitePackaging: acc.defaultLitePackaging || checkoutInfo.includes("defaultLitePackaging")
        };
      },
      {
    ...
    const mobileImage = mobile_image ? mobile_image : "https://cdn.shopify.com/s/files/1/0808/0021/9476/files/Lite_Packaging_Mobile.jpg?v=1724336458";
    const desktopImage = desktop_image ? desktop_image : "https://cdn.shopify.com/s/files/1/0808/0021/9476/files/Lite_Packaging_Desktop.jpg?v=1724336481";
    const charityInfo = charity_info || "The Bike Project help get refugees and asylum seekers on bikes";
    const charityDonation2 = Number(charity_donation) || 1.5;
    const totalCharityValue = `\xA3${(litePackagingCount * charityDonation2).toFixed(2)}`;
    ...
    if (litePackagingAvailable) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { rows: "auto", display: litePackagingAvailable ? "auto" : "none", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Grid2,
          {
            ...
            rows: "auto",
            children: packaging === "lite" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { rows: "auto", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "success", emphasis: "bold", children: "Lite Packaging\u2122 Selected" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "success", children: "Thanks for choosing to make a difference!" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Button2,
                {
                  ...
                  children: "Switch to full packaging"
                }
              )
                ...
                Grid2,
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                      Pressable2,
                      {
                        overlay: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Tooltip2, { children: charityInfo }),
                        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Icon2, { source: "question" })
                      }
                    ),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "small", children: [
                      "We'll strip back your packaging to reduce your order's emissions, and donate ",
                      totalCharityValue,
  ...
  function CharityDonation() {
    ...
    const totalCharityValue = `\xA3${(litePackagingCount * 1.5).toFixed(2)}`;
    if (packaging == "lite") {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "success", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "small", children: [
        "Including a ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "small", emphasis: "bold", children: [
          totalCharityValue,
          " charity donation"
        ] }),
...
//# sourceMappingURL=lite-packaging.js.map
