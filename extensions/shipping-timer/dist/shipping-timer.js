(() => {
  ...
  // extensions/shipping-timer/src/ShippingTimer.tsx
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/country.mjs
  ...
  function useShippingOptionTarget() {
    ...
    const shippingOption = (0, import_react14.useMemo)(() => {
      return {
  ...
  // extensions/shipping-timer/src/calculateShipping.ts
  ...
  var despatchDate;
  var delivery;
  var timeNow = (0, import_dayjs.default)().tz("Europe/London");
  function calculateShipping(context, date, config, data) {
    countryData = data;
  ...
  function calculateDespatchDay(date, context) {
    const baseDate = date ? (0, import_dayjs.default)(date) : timeNow;
    switch (context) {
  ...
  function calculateDeliveryTitle(deliveryDates) {
    const today = (0, import_dayjs.default)();
    const daysUntilDelivery = (0, import_dayjs.default)(deliveryDates.min).diff(today, "day");
  ...
  function checkDespatching(date) {
    const formattedDate = date.format("YYYY-MM-DD");
    if (shippingConfig.shippingNonShipDays.includes(formattedDate) || shippingConfig.shippingNonDespatch.includes(formattedDate)) {
      date = date.add(1, "day");
    }
    return checkIfWeekend(date);
  }
  function checkDelivering(date) {
    const formattedDate = date.format("YYYY-MM-DD");
  ...
  function calculatePrefix(context) {
  ...
  // extensions/shipping-timer/src/formatData.ts
  function formatData(data, type) {
    if (type == "config") {
      return data.reduce(
        (accumulator, { key, value }) => __spreadProps(__spreadValues({}, accumulator), {
  ...
  function filterByIsoCode(data, localization) {
  ...
  var shippingTimer = reactExtension(
    "purchase.checkout.shipping-option-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ShippingTimer, {})
  );
  var preOrderBanner = reactExtension(
    "purchase.checkout.shipping-option-list.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PreorderBanner, {})
  );
  var showFakeItems = false;
  var fakeCartItems = [
    {
      attributes: []
    },
  ...
  function ShippingTimer() {
    const [productContext, setProductContext] = (0, import_react15.useState)("default");
    const [shippingDate, setShippingDate] = (0, import_react15.useState)("");
    const [shipping, setShipping] = (0, import_react15.useState)(null);
    const [isLoading, setIsLoading] = (0, import_react15.useState)(true);
    const [config, setConfig] = (0, import_react15.useState)(null);
    const [methods, setMethods] = (0, import_react15.useState)(null);
    const { query } = useApi();
    ...
    const updateProductContext = () => __async(this, null, function* () {
      ...
      const {
        ...
        (acc, item) => {
          ...
          const checkoutInfo = ((_a = attributes.find((attr) => attr.key === "_checkoutInfo")) == null ? void 0 : _a.value) || "";
          const despatchDate2 = (_b = attributes.find(
            (attr) => attr.key === "_despatchDate"
          )) == null ? void 0 : _b.value;
          return {
            isPrescription: acc.isPrescription || checkoutInfo.includes("isPrescription"),
            isPreorder: acc.isPreorder || checkoutInfo.includes("isPreorder"),
            isDelayedDespatch: acc.isDelayedDespatch || checkoutInfo.includes("delayedDespatch"),
            // Always let the despatchDate be the latest date
            variableDespatchDate: despatchDate2 ? new Date(despatchDate2) > new Date(acc.variableDespatchDate) ? despatchDate2 : acc.variableDespatchDate : acc.variableDespatchDate
          };
        },
        {
      ...
      if (isPrescription && !variableDespatchDate) {
        ...
        setProductContext(
          isPreorder ? "preorder" : isDelayedDespatch ? "delayedDespatch" : "default"
        );
        setShippingDate(variableDespatchDate);
      }
      if (config && methods) {
        try {
          const shippingOptions = yield methods.map((item) => __spreadValues({
            name: item.name,
            type: item.type
    ...
    if (isLoading) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SkeletonText2, { inlineSize: "base", size: "base" });
    }
    if (shipping) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        matchedOption && matchedOption.type !== "Standard" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "base", children: matchedOption.prefix }),
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "base", appearance: matchedOption.fastDelivery ? "success" : "accent", children: matchedOption.despatchDate })
        ] }),
        matchedOption && matchedOption.type === "Standard" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "base", children: matchedOption.prefix }),
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "base", appearance: "subdued", children: matchedOption.despatchDate })
        ] })
      ] });
    }
  }
...
//# sourceMappingURL=shipping-timer.js.map
